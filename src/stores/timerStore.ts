 ...
 *
 * Cross-Device-Sync: bewusst NICHT in v3. Ein Versuch in M3b.6 (running_
 * timers-Table mit fire-and-forget push + replace-on-pull) wurde wieder
 * zurückgerollt, weil silent push-failures destruktiv waren — die
 * lokalen Slots wurden nach einem Refresh weggelöscht, wenn der Server
 * den Push nie erhalten hatte. Eine saubere Implementation bräuchte
 * await-on-push mit Konflikt-Handling und ein UX-Modell für Pending-
 * Writes — Aufwand größer als der Nutzen für ein Single-User-Tool.
 *
